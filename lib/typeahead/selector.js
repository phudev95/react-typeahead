...
var TypeaheadSelector = React.createClass({
    ...
    render: function () {
        ...
        var results = this.props.options.map(function (result, i) {
            var displayOption = Accessor.getValueOfDisplayOption(this.props.displayOption(result, i));
            var displayJSX = displayOption.jsx;
            var uniqueKey = displayOption.jsx.value + '_' + i;
            ...
            return React.createElement(TypeaheadOption, {
                ...
                customClasses: this.props.customClasses,
                onClick: this._onClick.bind(this, result) // apple
            }, displayJSX);
        }, this);
