...
var Typeahead = React.createClass({
    ...
    _onOptionSelected: function (option, event) {
        ...
        // Get optionString
        var displayOptionFn = Accessor.generateOptionToStringFor(this.props.inputDisplayOption || this.props.displayOption);
        var displayOption = Accessor.getValueOfDisplayOption(displayOptionFn(option, 0));
        var optionString = displayOption.value;

        var formInputOption = Accessor.generateOptionToStringFor(this.props.formInputOption || displayOptionFn);
        var formInputOptionString = formInputOption(option);

        nEntry.value = optionString;
        this.setState({
            searchResults: this.getOptionsForValue(optionString, this.props.options),
            selection: formInputOptionString.value ? formInputOptionString.value : formInputOptionString,
    ...
    render: function () {
        ...
        return React.createElement('div', { className: classList }, this._renderHiddenInput(), React.createElement(InputElement, _extends({ ref: 'entry', type: 'text', disabled: this.props.disabled }, this.props.inputProps, {
